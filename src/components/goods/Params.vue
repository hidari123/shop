          ...
          <el-table :data="manyTableData" border stripe>
            ...
            <el-table-column type="expand">
              <template v-slot="scoped">
                <!-- 循环渲染Tag标签 -->
                <el-tag closable v-for="(item, index) in scoped.row.attr_vals" :key="index"
                        @close="handleClosed(index, scoped.row)"> {{ item }}
                </el-tag>
                <!-- 输入的文本框 -->
                <el-input
                  class="input-new-tag"
                ...
                <el-button v-else class="button-new-tag" size="small" @click="showInput(scoped.row)">+ New Tag
                </el-button>
              </template>
            </el-table-column>
            <!--            索引列-->
            ...
            <el-table-column label="操作">
              <template v-slot="scoped">
                <el-button type="primary" size="mini" icon="el-icon-edit" @click="showEditDialog(scoped.row.attr_id)">
                  编辑
                </el-button>
                <el-button type="danger" size="mini" icon="el-icon-delete"
                           @click="removeParamsById(scoped.row.attr_id)">删除
                </el-button>
              </template>
            </el-table-column>
          </el-table>
